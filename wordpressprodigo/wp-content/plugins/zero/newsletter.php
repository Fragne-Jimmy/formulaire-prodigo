...
include_once 'newsletterwidget.php';
...
class Zero_Newsletter
{
    ...
    public function register_settings()
    {
      ...
      add_settings_field('zero_newsletter_object', 'Object', array($this, 'object_html'), 'zero_newsletter_settings', 'zero_newsletter_section');
