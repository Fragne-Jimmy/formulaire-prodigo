...
$themater_facebook_defaults = array(
    'title' => 'Facebook',
    'url' => 'http://www.facebook.com/envato',
    'width' => '297',
    'height' => '450',
    'colorscheme' => 'light',
    'show_faces' => 'true',
...
add_action('widgets_init', create_function('', 'return register_widget("vazzFacebook");'));

class vazzFacebook extends WP_Widget 
{
    function __construct() 
    {
        $widget_options = array('description' => __('Facebook Like Box social widget. ', 'themater') );
        $control_options = array( 'width' => 440);
		$this->WP_Widget('themater_facebook', '&raquo; Vuzz Facebook Like Box', $widget_options, $control_options);
    }
    ...
    function widget($args, $instance)
    {
        ...
        ?>
        <div class="sidebarBox"><ul class="widget-container"><li class="facebook-widget">
        <?php  if ( $title ) {  ?> <h4 class="widget-title"><?php echo $title; ?></h4> <?php }  ?>
            <div id="fb-root"></div>
